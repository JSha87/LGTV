...
1. Create Folders
batchmkdir "L:\Obsidian\Obsidian Vault\Scripts\LGTV"
...
cd "***\LGTV"
python lgtv.py
This creates C:\ProgramData\LGTVControl\lgtv_store.json. Edit it and fill in TV_MAC and SUBNET.
...
✅ Scripts on L: drive - Easy to edit and version control
...
The key is that the Python script and MultiMonitorTool.exe are in your Obsidian vault for easy access, while the credentials and logs are stored in ProgramData where both your user account and SYSTEM can read/write them!